...
export const EvaluationQueueView: React.FC<EvaluationQueueViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div className="bg-card rounded-sm border border-white/80 p-5 sm:p-6 shadow-xs">
            ...
            {pendentes.map((a) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => onAvaliar(a)}
                  className="shrink-0 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-sm bg-brand text-white text-label font-semibold uppercase tracking-wider hover:bg-brand-hover active:scale-95 transition-all"
                >
